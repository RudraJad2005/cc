    ...
    <footer className="w-full relative overflow-hidden bg-[#080808]">
      <div className="p-8 md:p-12 lg:p-20 xl:p-[100px] flex flex-col md:flex-row justify-between gap-12 relative z-10 w-full mx-auto">
        <div className="flex flex-col max-w-[280px]">
          <div className="w-[24px] h-[24px] rounded-full border-2 border-transparent bg-white flex items-center justify-center overflow-hidden relative mb-6" style={{ boxShadow: 'inset 0 0 0 1px rgba(0,0,0,0.1)'}}>
