...
export function SignUp() {
  ...
  const handleOAuthLogin = async (provider: 'github' | 'google' | 'bitbucket') => {
  ...
  return (
    <div className="w-full max-w-[400px] flex flex-col items-center">
      ...
      <div className="text-center mb-8">
         ...
         <p className="text-gray-400 text-sm">Join Collab Code and start building today.</p>
      </div>
      ...
      <div className="w-full bg-[#050505] border border-white/[0.08] rounded-2xl p-6 sm:p-8 shadow-2xl">
         ...
         {success && (
          ...
          <div className="flex flex-col gap-3 mb-6">
            ...
            <button onClick={() => handleOAuthLogin('google')} className="w-full flex items-center justify-center gap-3 bg-[#0A0A0A] hover:bg-[#111] border border-white/[0.1] hover:border-white/[0.2] transition-colors text-white py-2.5 rounded-lg text-sm font-medium">
