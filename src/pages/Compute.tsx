             ...
             <div className="max-w-[1200px] mx-auto border-x border-white/[0.1] relative">
                ...
                <div className="flex flex-col border-b border-white/[0.1] relative">
                   ...
                   <div className="text-center py-24 px-6 relative">
                      ...
                      <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tighter text-white mb-6">Zero local overhead.</h2>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 relative border-t border-white/[0.1]">
                         ...
                         <div className="w-full h-full flex items-end justify-center gap-2">
                            {[40, 70, 50, 90, 60, 30].map((h, i) => (
                               <motion.div 
                                 ...
                                 className="w-8 bg-white/[0.05] border border-white/[0.1] rounded-t-sm"
                               />
                            ))}
                         </div>
                      </div>
                      ...
                      {/* Col 2: Terminal */}
                      <div className="col-span-1 border-r border-white/[0.1] p-10 lg:p-16 flex items-center justify-center h-[300px]">
                         <div className="w-full max-w-[280px] rounded-lg border border-white/[0.1] bg-[#050505] p-4 font-mono text-[10px] text-gray-400">
                            <p className="text-white mb-2">~ collab up --tier pro</p>
                            <p className="mb-1 text-gray-500">Provisioning MicroVM...</p>
                            <div className="pl-2 border-l border-white/[0.1] flex flex-col gap-1 mb-2">
                         ...
                         <div className="relative w-full aspect-square flex items-center justify-center">
                            ...
                            {[1, 2, 3].map((i) => (
                               <motion.div
                                 ...
                                 className="absolute inset-0 m-auto w-16 h-16 rounded-full border border-white/[0.1]"
                               />
                            ))}
                         </div>
                      </div>
                ...
                <div className="flex flex-col relative border-b border-white/[0.1]">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3">
                      <div className="col-span-2 border-r border-white/[0.1] p-16 md:py-32 md:px-24 flex items-center">
                         <h2 className="text-4xl md:text-5xl font-medium tracking-tighter text-white">From keystroke to deploy.</h2>
                      </div>
                ...
                <div className="flex flex-col relative border-b border-white/[0.1]">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3">
                      <div className="col-span-2 border-r border-white/[0.1] p-16 md:py-32 md:px-24 flex items-center">
                         <h2 className="text-4xl md:text-5xl font-medium tracking-tighter text-white">Built for scale.</h2>
                      </div>
                      <div className="col-span-1 p-16 flex items-center justify-center gap-6">
                         <div className="flex items-center gap-2 text-gray-400 font-mono text-sm border border-white/[0.1] px-4 py-2 rounded-full"><Cpu className="w-4 h-4"/> Hardware</div>
                      </div>
                   </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 relative border-t border-white/[0.1]">
                      ...
                      {[
                         ...
                         <div key={i} className={`col-span-1 p-8 lg:p-10 border-b border-white/[0.1] ${i % 3 !== 2 ? 'border-r border-white/[0.1]' : ''}`}>
                ...
                <div className="flex flex-col relative border-b border-white/[0.1]">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3">
                      <div className="col-span-3 p-16 md:py-24 text-center">
                         <h2 className="text-4xl md:text-5xl font-medium tracking-tighter text-white">Right-sized for every workload.</h2>
                      </div>
                   </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 relative border-t border-white/[0.1]">
                      ...
                      {[
                         { name: 'Hobby', price: '$0', unit: '/mo', desc: 'For side projects and exploration.', specs: ['4 vCPU dedicated', '8GB RAM', '60h compute / month'], cta: 'Start free' },
                         { name: 'Pro', price: '$20', unit: '/mo', desc: 'For professional developers.', specs: ['8 vCPU dedicated', '16GB RAM', 'Unlimited compute'], cta: 'Start Pro trial' },
                         { name: 'Enterprise', price: 'Custom', unit: '', desc: 'For organizations at scale.', specs: ['16 vCPU + bare metal', '64GB RAM', 'SSO / SAML'], cta: 'Contact sales' },
                      ].map((t, i) => (
                         <div key={i} className={`col-span-1 p-10 lg:p-16 flex flex-col hover:bg-white/[0.02] transition-colors ${i < 2 ? 'border-r border-white/[0.1]' : ''}`}>
                            ...
                            <button className="w-full py-3 border border-white/[0.2] rounded-full text-[14px] font-medium text-white hover:bg-white hover:text-black transition-colors mb-8">
                               {t.cta}
                            </button>
                            <div className="flex flex-col gap-3">
                               {t.specs.map((s, j) => (
                                  <div key={j} className="flex items-center gap-3 text-[14px] text-gray-400">
                                     <Check className="w-4 h-4 text-white" /> {s}
                                  </div>
                               ))}
                            </div>
                         </div>
